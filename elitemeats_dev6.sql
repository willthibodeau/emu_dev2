...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2016 at 05:49 PM
...
(3, 5, '100', 'bacon', 'yummy', '500.00', '0000-00-00 00:00:00', '', '');
...
INSERT INTO `users` (`users_userID`, `users_username`, `users_password`, `users_userLevel`, `users_firstName`, `users_lastName`) VALUES
...
--
ALTER TABLE `categories`
  MODIFY `cat_categoryID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `products`
  MODIFY `prod_productID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
