<?php 
echo 'this is the product list.php in admin';
        ...
        <main>
            <article class="main">
                <p>You are logged in as <?php echo $_SESSION['admin']; ?>.</p>
                    ...
                    <main>
                        <a href="category_list.php">Category Manger</a><br>
                        <a href="product_list.php">Product Manager</a><br>
                ...
                <table>
                    ...
                    <p><a href=".?action=category_list">List Categories</a></p>        
                </section>
