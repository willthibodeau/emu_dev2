...
//   Description: Allows the admin to add products to categories                                      /
//                                                                                                    /
/////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
<div class="main-content">
    ...
    <form action="." method="post" class="formInput">
        ...
        <select name="imagePath">
            ...
            <option value="<?php echo $get_image ; ?>" id="imagePath" required="required"><?php echo htmlspecialchars($get_image); ?>
            </option>
            <?php endforeach; ?>
        </select><br>
